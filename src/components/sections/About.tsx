...
export function About() {
  ...
  return (
    <Section id="about" className="bg-brand-darker">
      <Container>
        <SectionHeader title={siteConfig.about.title} subtitle="Концепция" />

        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-24 max-w-5xl mx-auto">
          {siteConfig.about.features.map((feature, index) => {
            const Icon =
              icons[feature.title as keyof typeof icons] || CheckCircle2;
            ...
            return (
              <motion.div
                ...
                className="glass-panel p-8 rounded-3xl relative group overflow-hidden w-full last:col-span-2 last:max-w-[320px] last:mx-auto md:last:col-span-1 md:last:max-w-none"
              >
